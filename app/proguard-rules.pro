...
-keep class com.zodiactap.mapper.data.entities.** { <fields>; }
...
-keep class com.zodiactap.mapper.api.IKeyEventRelayService { *; }
-keep class com.zodiactap.mapper.api.IKeyEventRelayService$Stub { *; }
-keep class com.zodiactap.mapper.api.IKeyEventRelayServiceCallback { *; }
-keep class com.zodiactap.mapper.api.IKeyEventRelayServiceCallback$Stub { *; }
...
-keep,includedescriptorclasses class com.zodiactap.mapper.**$$serializer { *; } # <-- change package name to your app's
-keepclassmembers class com.zodiactap.mapper.** { # <-- change package name to your app's
    *** Companion;
}
-keepclasseswithmembers class com.zodiactap.mapper.** { # <-- change package name to your app's
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.zodiactap.mapper.sysbridge.service.SystemBridge {
    public <methods>;
    native <methods>;
    static <methods>;
    <init>(...);
...
-keep class com.zodiactap.mapper.sysbridge.ISystemBridge** { *; }
-keep class com.zodiactap.mapper.evdev.IEvdevCallback** { *; }
-keep class com.zodiactap.mapper.sysbridge.IShizukuStarterService** { *; }

-keepclassmembers class com.zodiactap.mapper.sysbridge.shizuku.ShizukuStarterService {
    public <init>(...);
}

# Keep binder provider classes
-keep class com.zodiactap.mapper.sysbridge.provider.** { *; }

# Keep classes accessed via reflection or from system services
-keep class com.zodiactap.mapper.sysbridge.utils.** { *; }
...
-keep class com.zodiactap.mapper.sysbridge.** extends android.content.ContentProvider { *; }

# Keep parcelable classes used in AIDL
-keep class com.zodiactap.mapper.common.models.GrabbedDeviceHandle { *; }
-keep class com.zodiactap.mapper.common.models.EvdevDeviceInfo { *; }
-keep class com.zodiactap.mapper.common.models.GrabTargetKeyCode { *; }
-keep class com.zodiactap.mapper.common.models.ShellResult { *; }
