...
import com.zodiactap.mapper.base.utils.JsonTestUtils
import com.zodiactap.mapper.data.migration.JsonMigration
...
import com.zodiactap.mapper.data.migration.MigrationUtils
...
class KeyMapJsonMigrationTest {
    companion object {
        private val MIGRATION_9_10_TEST_DATA = listOf(
            "{\"actionList\":[{\"data\":\"com.google.android.contacts\",\"extras\":[],\"flags\":2,\"type\":\"APP\"}],\"constraintList\":[],\"constraintMode\":1,\"flags\":0,\"id\":0,\"isEnabled\":true,\"trigger\":{\"extras\":[],\"flags\":1,\"keys\":[{\"clickType\":0,\"deviceId\":\"com.zodiactap.mapper.THIS_DEVICE\",\"flags\":0,\"keyCode\":25}],\"mode\":2}}",
            "{\"actionList\":[{\"data\":\"com.google.android.contacts\",\"extras\":[],\"flags\":6,\"type\":\"APP\"}],\"constraintList\":[],\"constraintMode\":1,\"flags\":0,\"id\":0,\"isEnabled\":true,\"trigger\":{\"extras\":[],\"flags\":0,\"keys\":[{\"clickType\":0,\"deviceId\":\"com.zodiactap.mapper.THIS_DEVICE\",\"flags\":0,\"keyCode\":25}],\"mode\":2}}",
        )
        private val MIGRATION_9_10_EXPECTED_DATA = listOf(
            "{\"actionList\":[{\"data\":\"com.google.android.contacts\",\"extras\":[],\"flags\":0,\"type\":\"APP\"}],\"constraintList\":[],\"constraintMode\":1,\"flags\":0,\"id\":0,\"isEnabled\":true,\"trigger\":{\"extras\":[],\"flags\":17,\"keys\":[{\"clickType\":0,\"deviceId\":\"com.zodiactap.mapper.THIS_DEVICE\",\"flags\":0,\"keyCode\":25}],\"mode\":2}}",
            "{\"actionList\":[{\"data\":\"com.google.android.contacts\",\"extras\":[],\"flags\":4,\"type\":\"APP\"}],\"constraintList\":[],\"constraintMode\":1,\"flags\":0,\"id\":0,\"isEnabled\":true,\"trigger\":{\"extras\":[],\"flags\":16,\"keys\":[{\"clickType\":0,\"deviceId\":\"com.zodiactap.mapper.THIS_DEVICE\",\"flags\":0,\"keyCode\":25}],\"mode\":2}}",
        )
    }
