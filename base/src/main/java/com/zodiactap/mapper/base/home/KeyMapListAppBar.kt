...
import com.zodiactap.mapper.base.groups.DeleteGroupDialog
import com.zodiactap.mapper.base.groups.GroupBreadcrumbRow
import com.zodiactap.mapper.base.groups.GroupConstraintRow
import com.zodiactap.mapper.base.groups.GroupListItemModel
import com.zodiactap.mapper.base.groups.GroupRow
...
import com.zodiactap.mapper.base.utils.ui.compose.icons.Import
...
private fun constraintsSampleList(): List<ComposeChipModel> {
    ...
    return listOf(
        ...
        ComposeChipModel.Error(
            ...
            error = KMError.AppNotFound("com.zodiactap.mapper"),
        ),
    )
}
