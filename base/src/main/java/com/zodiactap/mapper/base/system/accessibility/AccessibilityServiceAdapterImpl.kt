...
class AccessibilityServiceAdapterImpl @Inject constructor(
    ...
    private suspend fun getState(): AccessibilityServiceState {
        ...
        /* cant just use .contains because the debug and release accessibility service both contain
           com.zodiactap.mapper. the enabled_accessibility_services are stored as

             com.zodiactap.mapper.debug/com.zodiactap.mapper.service.MyAccessibilityService
             :com.zodiactap.mapper/com.zodiactap.mapper.service.MyAccessibilityService
