...
import com.zodiactap.mapper.base.utils.ui.compose.icons.FakeShizuku
import com.zodiactap.mapper.base.utils.ui.compose.icons.KeyMapperIcon
                ...
                setupState = State.Data(
                    ExpertModeState.Stopped(
                        ...
                        shellStartCommandState = ShellStartCommandState.Loaded(
                            "sh /storage/emulated/0/Android/data/com.zodiactap.mapper/files/start.sh",
                        ),
                    ),
                ),
                showInfoCard = false,
