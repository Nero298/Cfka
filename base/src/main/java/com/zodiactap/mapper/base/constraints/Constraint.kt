...
import com.zodiactap.mapper.common.utils.getKey
import com.zodiactap.mapper.common.utils.valueOrNull
import com.zodiactap.mapper.data.entities.ConstraintEntity
import com.zodiactap.mapper.data.entities.EntityExtra
import com.zodiactap.mapper.data.entities.getData
import com.zodiactap.mapper.system.camera.CameraLens
import com.zodiactap.mapper.system.volume.RingerMode as SystemRingerMode
...
sealed class ConstraintData {
    ...
    data class PhysicalOrientation(
        val physicalOrientation: com.zodiactap.mapper.common.utils.PhysicalOrientation,
    ) : ConstraintData() {
        override val id: ConstraintId = when (physicalOrientation) {
            com.zodiactap.mapper.common.utils.PhysicalOrientation.PORTRAIT ->
                ConstraintId.PHYSICAL_ORIENTATION_PORTRAIT
            com.zodiactap.mapper.common.utils.PhysicalOrientation.LANDSCAPE ->
                ConstraintId.PHYSICAL_ORIENTATION_LANDSCAPE
            com.zodiactap.mapper.common.utils.PhysicalOrientation.PORTRAIT_INVERTED ->
                ConstraintId.PHYSICAL_ORIENTATION_PORTRAIT_INVERTED
            com.zodiactap.mapper.common.utils.PhysicalOrientation.LANDSCAPE_INVERTED ->
