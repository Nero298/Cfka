...
import com.zodiactap.mapper.api.IKeyEventRelayServiceCallback
...
class KeyMapperImeService : InputMethodService() {
    companion object {
        ...
        private const val KEY_MAPPER_INPUT_METHOD_ACTION_INPUT_DOWN_UP =
            "com.zodiactap.mapper.inputmethod.ACTION_INPUT_DOWN_UP"
        private const val KEY_MAPPER_INPUT_METHOD_ACTION_INPUT_DOWN =
            "com.zodiactap.mapper.inputmethod.ACTION_INPUT_DOWN"
        private const val KEY_MAPPER_INPUT_METHOD_ACTION_INPUT_UP =
            "com.zodiactap.mapper.inputmethod.ACTION_INPUT_UP"
        private const val KEY_MAPPER_INPUT_METHOD_ACTION_TEXT =
            "com.zodiactap.mapper.inputmethod.ACTION_INPUT_TEXT"

        private const val KEY_MAPPER_INPUT_METHOD_EXTRA_TEXT =
            "com.zodiactap.mapper.inputmethod.EXTRA_TEXT"
        const val KEY_MAPPER_INPUT_METHOD_EXTRA_KEY_EVENT =
            "com.zodiactap.mapper.inputmethod.EXTRA_KEY_EVENT"
    ...
    private fun chooseIncompatibleIme() {
        ...
        inputMethodManager!!.enabledInputMethodList
            .filter {
                !it.packageName.contains("com.zodiactap.mapper")
            }
